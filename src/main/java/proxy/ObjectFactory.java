...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://sid.org/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://sid.org/", "ConvertResponse");
    private static final QName _Compte_QNAME = new QName("http://sid.org/", "compte");
    private static final QName _GetCompte_QNAME = new QName("http://sid.org/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://sid.org/", "getCompteResponse");
    private static final QName _ListCompte_QNAME = new QName("http://sid.org/", "listCompte");
    private static final QName _ListCompteResponse_QNAME = new QName("http://sid.org/", "listCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://sid.org/", name = "listCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://sid.org/", name = "listCompteResponse")
